...
namespace Bookstore.Data
{
    ...
    {
        // Npgsql legacy timestamp behaviour: treat DateTime as UTC without explicit Kind conversions
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                // Preserved customer relationship constraint
            ...
            // ----------------------------------------------------------------
            // ReferenceDataItem  (table name: referencedata)
            // ----------------------------------------------------------------
